...
#ifndef _OPTIMAL_DAMPING_ALGORITHM_
#define _OPTIMAL_DAMPING_ALGORITHM_
 ...
 */
class optimalDamping4RestrictedHartreeFock
{
private:
	/**
...
protected:
	 ...
	 */
	optimalDamping4RestrictedHartreeFock(const optimalDamping4RestrictedHartreeFock & oda4rhf);
...
public:
	 ...
	 */
	optimalDamping4RestrictedHartreeFock(void);
