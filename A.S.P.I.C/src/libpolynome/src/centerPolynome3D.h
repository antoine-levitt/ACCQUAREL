...
public:
	...
	/**
	 * Le constructeur avec spécification des coefficients du polynome.
	 *
	...
	/**
	 * Le constructeur avec spécification des coefficients du polynome et du centre.
	 *
	 * @param poly les coefficients avec lequels on souhaite initialiser l'objet.
	 *
	 * @param center le point de centrage de l'objet créé.
	 */
	 ...
	 *
	 * @param dimension parametre pour choisr avec quelle variable on souhaite opérer.
	 * Lorsque dimension prend la valeur 0, alors on opère sur la variable x, lorsque dimension
	 * prend la valeur 1 alors on opè-re sur la varaible y et lorsque dimension vaut 3 on opère
	 * avec la variable z.
	 *
